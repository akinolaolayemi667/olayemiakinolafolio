...
export const projects: TPortfolioProject[] = [
  {
    id: "voice-of-god",
    slug: "voice-of-god",
    title: "Voice of God Accessories",
    subtitle:
      "Retail and wholesale e-commerce for shoe materials, leather accessories, and shoemaking supplies",
    category: "E-commerce",
    categories: ["E-commerce", "Full Stack", "Business Platforms"],
    industry: "Fashion & shoemaking materials",
    clientType: "Private client engagement",
    summary:
      "Voice of God Accessories is a production storefront for shoemakers, designers, and fashion brands — covering retail shopping, wholesale catalogs, account dashboards, admin operations, and Paystack checkout on voiceofgod.store.",
    problem:
      "The brand needed a single digital storefront that could serve both walk-in retail buyers and wholesale accounts — with authenticated dashboards, product variants (sizes, styles, varieties), and reliable payments — without running separate tools for catalog, orders, and admin.",
    goals: [
      "Ship a live retail + wholesale storefront customers can trust",
      "Support product variants, cart, wishlist, compare, and checkout",
      "Give admins control of products, categories, customers, orders, and messages",
      "Connect auth, payments, and notifications through Supabase",
    ],
    solution:
      "A Vite + React SPA with React Router, Supabase Auth/data, Paystack edge functions, and role-based retail, wholesale, and admin experiences — deployed to Vercel with SPA rewrites and production domain voiceofgod.store.",
    architecture:
      "React 19 + TypeScript on Vite 8 with Tailwind CSS 4 and Framer Motion. Client state covers cart, wishlist, compare, and product catalog hooks. Supabase powers auth (email + Google OAuth), profiles/roles, catalog data, and storage. Edge functions handle Paystack initialize/verify/webhook plus notification email/WhatsApp. Vercel hosts the static build with SPA fallback rewrites.",
    responsibilities: [
      "Storefront UX for home, shop, product detail, wholesale, and legal pages",
      "Auth flows (login, signup, Google OAuth callback, password reset, profile setup)",
      "Retail / wholesale / customer dashboards and admin console",
      "Cart, checkout, Paystack integration, and order notifications",
      "Supabase schema, RLS-oriented roles, and deployment configuration",
    ],
    features: [
      "Retail shop with filters, variants, wishlist, and product compare",
      "Wholesale catalog path and wholesale account request flow",
      "Supabase auth with Google OAuth branded to voiceofgod.store",
      "Paystack checkout via secure edge functions",
      "Admin tools for products, categories, customers, orders, and messages",
      "SEO metadata, sitemap, robots, and Open Graph assets",
    ],
    technologyStack: [
      "React",
      "TypeScript",
    ...
    engineeringChallenges: [
      "Modeling retail vs wholesale account types and pending wholesale approval",
      "Keeping Paystack secrets server-side while the SPA stays static-hosted",
      "Supporting multi-size / multi-style / multi-variety product selection for shoe materials",
      "Branding Google OAuth redirects to the custom domain instead of *.supabase.co",
    ],
    results: [],
    businessImpact: [
      "Gives Voice of God Accessories a live commerce surface at voiceofgod.store",
      "Unifies retail browsing and wholesale buying under one authenticated platform",
      "Lets the business manage catalog and orders from an admin console instead of ad-hoc tools",
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        alt: "Voice of God Accessories wholesale grid — product materials presentation",
      },
      {
        src: "/images/projects/voiceofgod-products.jpg",
        alt: "Voice of God Accessories product collection — double soles and materials",
      },
      {
        src: "/images/projects/voiceofgod-brand.png",
        alt: "Voice of God Accessories brand Open Graph mark",
      },
    ],
    liveDemo: {
      url: "https://voiceofgod.store/",
      label: "Live store",
    },
    repository: {
      url: "https://github.com/Damgreat/VoiceofGod",
      visibility: "public",
    ...
    testimonial: null,
    seo: {
      title: "Voice of God Accessories Case Study — E-commerce Platform",
      description:
        "How HOLASVISION built Voice of God Accessories: Vite, React, Supabase, and Paystack for retail and wholesale shoe-materials commerce.",
      keywords: [
        "Voice of God Accessories",
        "e-commerce",
        "Supabase",
        "Paystack",
        "Vite",
